<%@tag language="java" description="projectStatus-sm" pageEncoding="UTF-8" trimDirectiveWhitespaces="true"%>
...
<span class="label label-${statusLabelStyle}" data-toggle="tooltip" title="${projectStatus}">
  <pro:fa icon="${statusIcon}" fixedWidth="true"/></span>